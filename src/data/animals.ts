...
const defs: Array<Animal> = [
  ...
  { id: 'swan', name: 'Swan', category: 'birds', accent: '#C9D8E6', emoji: '🦢' },
  { id: 'dove', name: 'Dove', category: 'birds', accent: '#D9CFC4', emoji: '🕊️' },
  { id: 'chick', name: 'Chick', category: 'birds', accent: '#F2C94C', emoji: '🐤' },
  { id: 'crow', name: 'Crow', category: 'birds', accent: '#6E6A78', emoji: '🐦‍⬛' },
  { id: 'cuckoo', name: 'Cuckoo', category: 'birds', accent: '#9AA8B8', emoji: '🐦' },
  { id: 'woodpecker', name: 'Woodpecker', category: 'birds', accent: '#C96A4A', emoji: '🐦' },
  { id: 'seagull', name: 'Seagull', category: 'birds', accent: '#A8BCC8', emoji: '🐦' },
  { id: 'nightingale', name: 'Nightingale', category: 'birds', accent: '#8A7A6A', emoji: '🐦' },
  { id: 'blackbird', name: 'Blackbird', category: 'birds', accent: '#5A535E', emoji: '🐦' },
  { id: 'robin', name: 'Robin', category: 'birds', accent: '#C87A5A', emoji: '🐦' },
  // Under the waves
  ...
  { id: 'orca', name: 'Orca', category: 'sea', accent: '#4A5A68', emoji: '🐳' },
  { id: 'beluga', name: 'Beluga', category: 'sea', accent: '#D8E4EC', emoji: '🐋' },
  { id: 'pilotwhale', name: 'Pilot Whale', category: 'sea', accent: '#5A7890', emoji: '🐋' },
  { id: 'otter', name: 'Otter', category: 'sea', accent: '#A67B5B', emoji: '🦦' },
  { id: 'shrimp', name: 'Shrimp', category: 'sea', accent: '#F2A2A2', emoji: '🦐' },
  { id: 'turtle', name: 'Turtle', category: 'sea', accent: '#7FA86B', emoji: '🐢' },
  { id: 'sealion', name: 'Sea Lion', category: 'sea', accent: '#C89A6B', emoji: '🦭' },
  { id: 'crab', name: 'Crab', category: 'sea', accent: '#E06A4A', emoji: '🦀' },
  { id: 'lobster', name: 'Lobster', category: 'sea', accent: '#C04A3A', emoji: '🦞' },
  // Tiny and buzzy
  ...
  { id: 'fly', name: 'Fly', category: 'bugs', accent: '#8A8A92', emoji: '🪰' },
  { id: 'wasp', name: 'Wasp', category: 'bugs', accent: '#E0A030', emoji: '🐝' },
  { id: 'hornet', name: 'Hornet', category: 'bugs', accent: '#C07830', emoji: '🐝' },
  { id: 'bumblebee', name: 'Bumblebee', category: 'bugs', accent: '#E8B830', emoji: '🐝' },
  { id: 'ant', name: 'Ant', category: 'bugs', accent: '#8A5A2A', emoji: '🐜' },
  { id: 'grasshopper', name: 'Grasshopper', category: 'bugs', accent: '#A0B050', emoji: '🦗' },
  { id: 'cicada', name: 'Cicada', category: 'bugs', accent: '#B09860', emoji: '🦗' },
  { id: 'katydid', name: 'Katydid', category: 'bugs', accent: '#90B860', emoji: '🦗' },
  { id: 'beetle', name: 'Beetle', category: 'bugs', accent: '#6A7A4A', emoji: '🪲' },
  { id: 'cockroach', name: 'Cockroach', category: 'bugs', accent: '#9A6A3A', emoji: '🪳' }
]
